...
const About = () => {
    return (
        <div className="grid gap-6 grid-cols-1 md:grid-cols-3 lg:grid-cols-4 w-11/12 mx-auto mt-8">
            {/* Section 1 */}
            <section className="bg-[#10101f] p-6 rounded-xl border-2 border-[#6a11cb] col-span-1 lg:col-span-2">
            ...
            {/* Section 2 */}
            <section className="bg-[#10101f] p-6 rounded-xl border-2 border-[#11cb5f] col-span-1 md:col-span-2">
            ...
            {/* Section 3 */}
            <section className="bg-[#10101f] p-6 rounded-xl border-2 border-[#1124cb] col-span-1">
            ...
            {/* Section 4 */}
            <section className="bg-[#10101f] p-6 rounded-xl border-2 border-[#cbbf11] col-span-1 lg:col-span-3">
                <Title size={2} title="Pourquoi je stream ?" />          <p>
            ...
            {/* Section 5 */}
            <section className="bg-[#10101f] p-6 rounded-xl border-2 border-[#cb1111] col-span-1">
            ...
            {/* Section 6 */}
            <section className="bg-[#10101f] p-6 rounded-xl border-2 border-[#11bfcb] col-span-1 md:col-span-2 lg:col-span-1">
            ...
            {/* Section 7 */}
            <section className="bg-[#10101f] p-6 rounded-xl border-2 border-[#cb11ac] col-span-1 md:col-span-2">
            ...
            {/* Section 8 */}
            <section className="bg-[#10101f] p-6 rounded-xl border-2 border-[#6a11cb] col-span-1 lg:col-span-3">
            ...
            {/* Section 9 */}
            <section className="bg-[#10101f] p-6 rounded-xl border-2 border-[#cb5511] col-span-1">
